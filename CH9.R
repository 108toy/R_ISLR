...
# the svm() function will perform multi-class classification using the one-versus-one approach
...
svmfit = svm(y~., data=dat , kernel ="radial", cost=10, gamma =1) # it will deal with the multi-class itself
plot(svmfit , dat)
